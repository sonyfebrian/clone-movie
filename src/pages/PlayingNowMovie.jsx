...
import { getMoviesNow } from "../service/api";
import Card from "../components/Card";
import PropTypes from "prop-types";

const PlayingNowMovie = ({ query }) => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      try {
        const fetchedMovieList = await getMoviesNow(query);
  ...
  return (
    <>
      {isLoading ? (
        ...
        <>
          <div className="container px-1 py-10 mx-auto" id="playing">
...
PlayingNowMovie.propTypes = {
  query: PropTypes.string.isRequired,
};
export default PlayingNowMovie;
